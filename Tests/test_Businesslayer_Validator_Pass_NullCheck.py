...
import Businesslayer_Validator_Pass_NullCheck


class Businesslayer_Validator_Pass_NullCheck_test(unittest.TestCase):
    def test_formValidate_BSL_1(self):
        mockObject = Businesslayer_Validator_Pass_NullCheck.Businesslayer_Pass_NullCheck()
